    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="pt-24 pb-16 flex items-center justify-center">
          <div className="animate-pulse text-muted-foreground">Loading requirements...</div>
        </div>
        <Footer />
      </div>
    );
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                <h1 className="text-4xl font-bold mb-2">
                  My <span className="bg-gradient-hero bg-clip-text text-transparent">Requirements</span>
                </h1>
                <p className="text-muted-foreground">
                  View and manage all your posted organ requirements
                </p>
              </div>
              <Button
                ...
                data-testid="post-new-requirement-button"
              >
            ...
            <Card className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold">{requirements.length}</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold">
                    {requirements.filter(r => r.status === "cancelled").length}
                  </p>
                </div>
              </div>
            </Card>
